...
const Main = () => {
    ...
    const calculate = async () => {
        if (isNumber(income) && isNumber(year)) {
        const taxOwned: TaxOwed[] = taxCalculator(Number(income), Number(year));
        ...
        <div style={styles.content}>
            ...
            <div style={styles.marginTop}>
                ...
                <div style={styles.contentButton}>
                    <button style={styles.button} onClick={calculate} disabled={income === '' || year === ''}>Calculate</button>
                </div>
            </div>
        </div>
    );
