...
const Main = () => {
    ...
    const handleIncome = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (isNaN(parsedValue) && numericValue !== '') {
        // If parsing fails and numericValue is not empty, clear the input value
        setIncome('');
        } else {
            setIncome(isNaN(parsedValue) ? '' : parsedValue);
        }
    };
    ...
    const formattedValue = income === '' ? '' : income.toLocaleString('en-US', {
        style: 'currency',
        currency: 'USD'
    });
        ...
        <div style={styles.content}>
            ...
            <div style={styles.marginTop}>
                <div style={styles.marginTop}>
                    ...
                    <div style={styles.marginTop}>
                        <input style={{...styles.input, ...styles.textInput}} value={formattedValue} type="text" id="income" name="income" placeholder='$' onChange={handleIncome} />
                    </div>
                </div>
                <div style={styles.marginTop}>
                    <div>
