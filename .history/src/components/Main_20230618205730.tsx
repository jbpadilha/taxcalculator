            ...
            <div style={styles.container}>
                ...
                {taxOwned && (
                    <div style={styles.contentResult}>
                        <div style={styles.titleResukt}>Marginal Tax Rate for yearly income of {formatIncome(income)} for the year of {year}:</div>
                        <div style={styles.table}>
                            ...
                            <div style={styles.row} key={tax.salary.toString()}>
                                <div style={styles.cell}>{tax.salary === 0 ? '$0 <=' : formatIncome(tax.salary)}</div>
                                <div style={styles.verticalLine}></div>
